...
from people_counter import processVideo
...
# t = threading.Thread(target=processVideo("./userapp/mobilenet_ssd/MobileNetSSD_deploy.prototxt","./userapp/mobilenet_ssd/MobileNetSSD_deploy.caffemodel","./userapp/videos/example_02.mp4"))
# t.daemon = True
# t.start()
...
@app.route("/")
def video_feed():
  print("[INFO] Entering /video method....")
  # return the response generated along with the specific media
  # type (mime type)
  return Response(processVideo("./userapp/mobilenet_ssd/MobileNetSSD_deploy.prototxt","./userapp/mobilenet_ssd/MobileNetSSD_deploy.caffemodel","./userapp/videos/example_02.mp4"))
...
def output():
  global totalUp, totalDown, lock
  while True:
    with lock:
      # if totalUp == 0:
      #     continue
      yield "\n Output is: " + str(totalUp)



#-----------------start of processVideo----------------
